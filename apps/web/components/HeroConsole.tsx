...
export function HeroConsole() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-xl">
      {/* Outer ambient glow */}
      <div className="absolute -inset-1.5 rounded-[2.5rem] bg-gradient-to-r from-[--b-accent]/20 via-[--b-iris]/15 to-transparent blur-2xl pointer-events-none opacity-70" />
      ...
      <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.03] p-2 shadow-[0_30px_70px_-20px_rgba(0,0,0,0.8)] backdrop-blur-2xl">
        {/* Inner Core */}
        <div className="relative overflow-hidden rounded-[calc(2rem-0.5rem)] border border-white/[0.08] bg-[--b-panel]/95 shadow-[inset_0_1px_1px_rgba(255,255,255,0.12)]">
          {/* Header Status Bar */}
          <div className="flex items-center justify-between border-b border-[--b-border] bg-[--b-surface]/60 px-4 py-2.5 backdrop-blur-md">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[11px] font-medium tracking-wider text-[--b-text-secondary] uppercase">
                Interactive Console
              </span>
            </div>

            <div className="flex items-center gap-1.5">
              <span className="rounded-full bg-[--b-bg] px-2 py-0.5 font-mono text-[10px] text-[--b-muted] border border-[--b-border]">
                60 FPS PHYSICS
              </span>
            </div>
          </div>
          ...
          <div className="flex border-b border-[--b-border] bg-[--b-surface]/30 p-1.5 gap-1">
            {tabs.map((tab) => {
                ...
                <button
                  ...
                  className={`relative flex-1 flex items-center justify-center gap-1.5 rounded-xl py-2 px-2 font-mono text-[11px] font-medium transition-all duration-300 ${
                    isSelected
                      ...
                      : "text-[--b-muted] hover:text-[--b-text-secondary] hover:bg-white/[0.02]"
                  }`}
                >
                  {isSelected && (
                    <motion.div
                      layoutId="activeConsoleTab"
                      className="absolute inset-0 rounded-xl bg-[--b-panel] border border-[--b-border] shadow-sm"
          ...
          <div className="relative min-h-[260px] flex flex-col items-center justify-center p-6 bg-gradient-radial from-[--b-surface]/40 to-transparent">
            <AnimatePresence mode="wait">
              ...
              {activeTab === "magnetic" && (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    <p className="font-mono text-[11px] text-[--b-muted] tracking-wide mb-1">
                      SPRING MASS POINTER PROXIMITY
                    </p>
                    <p className="text-xs text-[--b-text-secondary]">
                  ...
                  {/* Physics tuning knob */}
                  <div className="flex w-full max-w-xs items-center justify-between gap-3 rounded-lg border border-[--b-border] bg-[--b-surface]/60 px-3 py-2 text-xs">
                    <span className="font-mono text-[10px] text-[--b-muted]">Attraction Strength</span>
                    <input
                      type="range"
                      min="0.1"
                      max="0.9"
                      ...
                      className="w-24 accent-[--b-accent] cursor-pointer"
                    />
                    <span className="font-mono text-[10px] font-bold text-[--b-accent]">
              ...
              {activeTab === "otp" && (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 text-[11px] font-mono text-[--b-muted]">
                ...
                >
                  ...
                  >
                    ...
                    <div className="mt-5 flex items-center justify-between pt-3 border-t border-white/10 text-white/80 font-mono text-[10px]">
                      ...
                      <span className="text-[--b-accent]">INTERACTION READY</span>
                    </div>
                  </FxCard>
                </motion.div>
              )}
              ...
              {activeTab === "controls" && (
                ...
                >
                  <div className="grid w-full grid-cols-2 gap-3">
                    <div className="flex flex-col gap-2 rounded-xl border border-[--b-border] bg-[--b-surface]/40 p-3.5">
                      <span className="font-mono text-[10px] text-[--b-muted]">Hold Physics</span>
                      <HoldButton
                        holdDuration={1000}
                        onHoldComplete={() => {}}
                    ...
                    <div className="flex flex-col gap-2 rounded-xl border border-[--b-border] bg-[--b-surface]/40 p-3.5">
                      <span className="font-mono text-[10px] text-[--b-muted]">Ripple Feedback</span>
                  ...
                  <div className="flex w-full items-center justify-between gap-4 rounded-xl border border-[--b-border] bg-[--b-surface]/30 px-4 py-2.5">
                    <div className="flex items-center gap-3">
                      <Switch
                        checked={switchActive}
                        onChange={(e) => setSwitchActive(e.target.checked)}
                      />
                      <span className="text-xs text-[--b-text] font-medium">
          ...
          {/* Machine Code Dock */}
          <div className="flex items-center justify-between border-t border-[--b-border] bg-[#08090C] px-4 py-2.5 font-mono text-xs">
            <div className="flex items-center gap-2 overflow-hidden truncate">
              <span className="text-[--b-muted] select-none">$</span>
              <code className="truncate text-[11px] text-[--b-text-secondary]">
                {getCodeSnippet()}
              </code>
            </div>
            ...
            <button
              ...
              className="ml-3 shrink-0 rounded-md border border-white/10 bg-white/5 px-2.5 py-1 text-[10px] font-mono text-[--b-text] transition-all hover:bg-white/10 hover:border-white/20 active:scale-95"
            >
